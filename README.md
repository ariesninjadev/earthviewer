...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/earthviewer)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/earthviewer
```

A live public deployment of this template is available at [https://earthviewer.templates.workers.dev](https://earthviewer.templates.workers.dev)
